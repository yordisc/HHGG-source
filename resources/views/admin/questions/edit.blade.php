            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <select name="cert_type" class="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 text-sm">
                        <option value="social_energy" @selected(old('cert_type', $question->cert_type) === 'social_energy')>social_energy</option>
                        <option value="life_style" @selected(old('cert_type', $question->cert_type) === 'life_style')>life_style</option>
                    </select>
                </div>
