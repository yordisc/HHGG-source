            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <select name="cert_type" class="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 text-sm">
                        <option value="hetero" @selected(old('cert_type', $question->cert_type) === 'hetero')>hetero</option>
                        <option value="good_girl" @selected(old('cert_type', $question->cert_type) === 'good_girl')>good_girl</option>
                    </select>
                </div>
