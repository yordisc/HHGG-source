...
@section('content')
    <section class="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-sm sm:p-8">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="brand-title text-2xl font-bold text-[var(--ink)]">Nueva certificacion</h1>
                <p class="mt-1 text-sm text-slate-600">Crea un nuevo elemento del catalogo visible en home.</p>
            </div>
        ...
        @include('admin.certifications._form', [
            ...
            'method' => 'POST',
            'buttonLabel' => 'Crear certificacion',
        ])
    </section>
@endsection
