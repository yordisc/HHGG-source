...
@section('content')
    <section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-4 py-8">
        <div class="w-full max-w-lg">
            <!-- Logo / Header -->
            <div class="text-center mb-12">
                <div class="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 shadow-lg mb-4">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-8">
                    ...
                    <p class="mt-2 text-blue-100">Utiliza tu clave de acceso administrativo</p>
                </div>

                <!-- Form -->
                <div class="px-8 py-8">
                    @if (session('status'))
                        <div class="mb-6 flex items-start gap-3 rounded-xl border border-blue-200 bg-gradient-to-r from-blue-50 to-blue-50/50 p-4">
                    ...
                    <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-6">
                        ...
                        <div>
                            <label for="admin_key" class="block text-sm font-semibold text-slate-900 mb-2">
                ...
                <div class="border-t border-slate-200 bg-gradient-to-r from-slate-50 to-slate-50 px-8 py-6">
                    <p class="text-xs text-slate-600">
                        <strong class="text-slate-900">Ayuda:</strong> Si olvidaste tu clave, contacta al administrador del sistema.
                    </p>
                </div>
            </div>
            ...
            <div class="mt-8 rounded-lg border border-amber-200 bg-gradient-to-r from-amber-50 to-amber-50/50 p-4">
                <div class="flex gap-3">
                    <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-amber-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                    <p class="text-xs text-amber-900">
                        Acceso restringido. Usa esta clave solo si eres administrador autorizado.
                    </p>
                </div>
            </div>
